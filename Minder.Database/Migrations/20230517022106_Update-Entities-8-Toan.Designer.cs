...
namespace Minder.Database.Migrations
{
    ...
    [Migration("20230517022106_Update-Entities-8-Toan")]
    partial class UpdateEntities8Toan
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Minder.Database.Models.Group", b =>
                {
                    ...
                    b.Property<long>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(1684290066084L);
                    ...
                    b.Property<long>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(1684290066085L);
            ...
            modelBuilder.Entity("Minder.Database.Models.Message", b =>
                {
                    ...
                    b.Property<long>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(1684290066087L);
            ...
            modelBuilder.Entity("Minder.Database.Models.Stadium", b =>
                {
                    ...
                    b.Property<long>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(1684290066088L);
