...
namespace Minder.Database.Migrations
{
    ...
    [Migration("20230104095421_Add-UserIsActive")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Minder.Database.Models.Rank", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
            ...
            modelBuilder.Entity("Minder.Database.Models.Team", b =>
                {
                    ...
                    b.Property<long>("ReputationScore")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Minder.Database.Models.Team", b =>
                {
                    b.HasOne("Minder.Database.Models.Rank", "Rank")
                        .WithMany("Teams")
