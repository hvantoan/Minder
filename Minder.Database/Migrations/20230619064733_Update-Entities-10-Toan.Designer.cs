...
namespace Minder.Database.Migrations
{
    ...
    [Migration("20230619064733_Update-Entities-10-Toan")]
    partial class UpdateEntities10Toan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Minder.Database.Models.TimeItem", b =>
                {
                    b.Property<string>("Id")
                    ...
                    b.Property<string>("TimeOpptionId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("TimeOpptionId");

                    b.ToTable("TimeItem", (string)null);
                });

            modelBuilder.Entity("Minder.Database.Models.TimeOpption", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("TimeOpption", (string)null);
                });
            ...
            modelBuilder.Entity("Minder.Database.Models.User", b =>
                {
                    ...
                    b.Property<long>("DayOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(1687157253098L);
            ...
            modelBuilder.Entity("Minder.Database.Models.TimeItem", b =>
                {
                    b.HasOne("Minder.Database.Models.TimeOpption", "TimeOpption")
                        .WithMany("TimeItems")
                        .HasForeignKey("TimeOpptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TimeOpption");
                });

            modelBuilder.Entity("Minder.Database.Models.TimeOpption", b =>
                {
                    b.HasOne("Minder.Database.Models.Match", "Match")
                        .WithMany("TimeOpptions")
